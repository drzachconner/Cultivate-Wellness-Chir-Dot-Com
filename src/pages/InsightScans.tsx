  ...
  return (
    <>
      ...
      <section className="relative py-32 bg-gray-900 min-h-[500px] flex items-center">
        ...
        <div className="absolute inset-0 z-0 bg-gradient-to-r from-primary-dark/60 to-primary/50" />
      ...
      <section className="pt-8 pb-4 bg-white">
        <div className="flex justify-center px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl px-8 sm:px-12 py-5 text-center inline-block" style={{ boxShadow: '0 8px 40px rgba(0, 45, 78, 0.2)' }}>
            <h2 className="text-3xl font-bold text-primary-dark">
              Three Neurological Scans
            </h2>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="aspect-[4/3] overflow-hidden rounded-xl shadow-lg">
              <img
                src="/images/semg-scan-child.webp"
                alt="sEMG scan being performed on a child"
                className="w-full h-full object-cover"
                loading="lazy"
              />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">neuroTHERMAL Scan</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                ...
                <Link to="/conditions/immune-support" className="text-primary-dark underline hover:text-primary-accent">immune</Link>, and hormonal regulation at their neurological root.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Quick, painless, and safe for all ages — from newborns to seniors.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="md:order-2 aspect-[4/3] overflow-hidden rounded-xl shadow-lg">
              <img
                src="/images/insight-semg-scan.webp"
                alt="neuroCORE sEMG scan being performed along a patient's spine"
                className="w-full h-full object-cover"
                loading="lazy"
              />
            </div>
            <div className="md:order-1">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">neuroCORE (sEMG) Scan</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                Surface electromyography measures the electrical activity in the muscles along your spine, revealing where your body is holding tension, guarding, and wasting energy.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Patterns of imbalance here are closely tied to conditions like{' '}
                ...
                <Link to="/conditions/autism-neurodevelopmental" className="text-primary-dark underline hover:text-primary-accent">neurodevelopmental challenges</Link>. These patterns show us exactly where the nervous system is working too hard or not hard enough.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="aspect-[4/3] overflow-hidden rounded-xl shadow-lg">
              <img
                src="/images/insight-hrv-scan.webp"
                alt="Child's hand on neuroPULSE HRV scanner with results displayed on screen"
                className="w-full h-full object-cover"
                loading="lazy"
              />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">neuroPULSE (HRV) Scan</h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                Heart Rate Variability measures your body's ability to adapt to stress by analyzing the balance between your sympathetic ("gas pedal") and parasympathetic ("brake pedal") nervous system.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                A low HRV score reveals a nervous system stuck in{' '}
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <img
                src="/images/insight-corescore-report.webp"
                alt="Children's CORESCORE neurological scan report showing Adaptability Reserve, Postural Energy, and Temperature Balance results"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              <img
                src="/images/insight-thermal-scan-child.jpeg"
                alt="neuroTHERMAL scan being performed on a child"
                className="rounded-xl shadow-lg"
              />
            </div>
          </div>
