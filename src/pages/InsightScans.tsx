...
const insightFaqs = [
  {
    question: 'What are INSiGHT scans and what do they measure?',
    answer: 'INSiGHT scans are a suite of three non-invasive, non-radiating neurological assessments used to objectively measure how well your nervous system is functioning. The neuroTHERMAL scan measures temperature differences along the spine to reveal autonomic nervous system imbalance. The neuroCORE (sEMG) scan uses surface electromyography to detect muscle tension patterns and energy waste. The neuroPULSE (HRV) scan measures Heart Rate Variability to assess stress adaptability. Together they generate a CORE Score — a single number reflecting overall neural efficiency.',
  },
  {
    question: 'Are INSiGHT scans safe for babies and children?',
    answer: 'Yes, INSiGHT scans are completely safe for all ages — from newborns just hours old through seniors. They are non-invasive (surface sensors only), emit zero radiation, require no needles or swallowing anything, and cause no discomfort. Parents can hold their baby throughout the entire scan process. This is one reason Dr. Zach uses them as the foundation of every care plan at Cultivate Wellness.',
  },
  {
    question: 'How long does an INSiGHT scan take?',
    answer: 'The full three-scan assessment typically takes 15–20 minutes. Each individual scan takes only a few minutes to complete. Results are available immediately and Dr. Zach reviews them with you during your Report of Findings appointment, explaining what the patterns mean and how they guide your personalized care plan.',
  },
  {
    question: 'Do I need to be scanned at every visit?',
    answer: 'No — routine visits are for adjustments, not full scans. Dr. Zach uses the initial scan to establish a baseline and create your care plan. Re-scans are done periodically (typically every 4–8 weeks or at key milestones) to objectively track how your nervous system is responding to care. This allows the care plan to be updated based on real data, not guesswork.',
  },
  {
    question: 'What is the CORE Score?',
    answer: 'The CORE Score is a single number (0–100) generated by combining the results of all three INSiGHT scans. It represents your overall neural efficiency — how well your nervous system is adapting, healing, and functioning. A higher score indicates a more resilient, balanced nervous system. The CORE Score gives Dr. Zach and patients an objective, easy-to-track measure of neurological progress over the course of care.',
  },
];
...
export default function InsightScans() {
  return (
    <>
      ...
      <JsonLd data={faqSchema(insightFaqs)} />
      <JsonLd
