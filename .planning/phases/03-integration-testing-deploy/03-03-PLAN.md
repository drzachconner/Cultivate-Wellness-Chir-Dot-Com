...
11. Navigate to the home page — verify hero, services, testimonials render
12. Click through to a service page (e.g., Pediatric) — verify content loads
13. Click through to a condition page (e.g., /conditions/adhd-focus-issues) — verify content
14. Open the public chatbot (bottom-right widget) — send a test message
15. Navigate to Contact Us — verify form renders (no need to submit)
16. Check browser console for errors — should be clean (no 500s, no CORS errors)
